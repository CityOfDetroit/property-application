...
context('Appliation Scenario 2', () => {
    ...
    it('Link to Map', () => {
        ...
        cy.contains('Thanks for your interest! Here are some resources that can assist your search. Please submit this application when you have a property identified.')
        cy.contains('Visit Map')
    })
